...
namespace Day08LineComparision
{
    ...
    public class Program2
    {
        public static void Main()
        {
            ...
            Double line01length;
            line01length = ObjClsLine01.line01Method(2.2, 3.3, 5.5, 9.9, 1);
            Double line02length;
            line02length = ObjClsLine02.line01Method(2.5, 4.3, 5.4, 9.5, 2);

            if (line01length.Equals(line02length))
            ...
            {
                Console.WriteLine("Line01 is not equals to line02");
            }
